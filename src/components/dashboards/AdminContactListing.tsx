...
const AdminContactListing: React.FC = () => {
  ...
  const { data } = useFetch("contact_us_list");
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">Contact-us Listing</h2>
            ...
            <TableBody>
              {currentListings.map(listing => (
                <TableRow key={listing.id}>
                  ...
                  <TableCell>{listing.message}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
...
export default AdminContactListing;
