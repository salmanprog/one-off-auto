...
import VehicleDocumentation from 'App/Models/VehicleDocumentation';
import _ from 'lodash'

export default class VehicleDocumentationController extends RestController
{
    ...
    constructor() {
        super("VehicleDocumentation");
        this.__resource = "VehicleDocumentation";
