...
import VehicleHpOutRange from 'App/Models/VehicleHpOutRange';
import _ from 'lodash'

export default class VehicleHpOutRangeController extends RestController
{
    ...
    constructor() {
        super("VehicleHpOutRange");
        this.__resource = "VehicleHpOutRange";
