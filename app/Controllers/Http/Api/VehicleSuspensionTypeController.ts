...
import VehicleSuspensionType from 'App/Models/VehicleSuspensionType';
import _ from 'lodash'

export default class VehicleSuspensionTypeController extends RestController
{
    ...
    constructor() {
        super("VehicleSuspensionType");
        this.__resource = "VehicleSuspensionType";
