...
import VehicleFuelType from 'App/Models/VehicleFuelType';
import _ from 'lodash'

export default class VehicleFuelTypeController extends RestController
{
    ...
    constructor() {
        super("VehicleFuelType");
        this.__resource = "VehicleFuelType";
