...
import VehicleDriverType from 'App/Models/VehicleDriverType';
import _ from 'lodash'

export default class VehicleDriverTypeController extends RestController
{
    ...
    constructor() {
        super("VehicleDriverType");
        this.__resource = "VehicleDriverType";
