...
import VehicleMotorSize from 'App/Models/VehicleMotorSize';
import _ from 'lodash'

export default class VehicleMotorSizeController extends RestController
{
    ...
    constructor() {
        super("VehicleMotorSize");
        this.__resource = "VehicleMotorSize";
