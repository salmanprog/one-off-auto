...
import VehicleSellerType from 'App/Models/VehicleSellerType';
import _ from 'lodash'

export default class VehicleSellerTypeController extends RestController
{
    ...
    constructor() {
        super("VehicleSellerType");
        this.__resource = "VehicleSellerType";
