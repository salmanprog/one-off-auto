...
import VehicleTransmissionType from 'App/Models/VehicleTransmissionType';

class VehicleTransmissionTypeHook
{
     /**
    ...
    public static async beforeCreateHook(request: object, params:object)
    {
        ...
        let slug      = await VehicleTransmissionType.generateSlug(params.title);
        params.slug       = slug
...
module.exports = VehicleTransmissionTypeHook;
