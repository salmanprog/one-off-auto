...
export default class VehicleModel extends RestModel
{
    public static table = 'vehicle_models'
    ...
    {
        return [
          'title','slug','make_id','year','description','image_url','created_at','updated_at','deleted_at'
        ]
    }
