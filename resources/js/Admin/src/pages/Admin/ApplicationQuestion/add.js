...
const AddQuestion = () => {
  const { data } = useFetch("get_application_category", "mount", '?category_type=quiz&limit=5000');
  const { loading, postData } = useFetch("add_application_questions", "submit");
  ...
  const onFinish = (values) => {
    ...
    const callback = (receivedData) => {
      return navigate("/admin/application-questions");
    };
  ...
  return (
    ...
    <ContentWrapper title='Application Questions'>
        ...
        <div className='row'>
          <div className="col-sm-12">
            ...
            >
              ...
              <div className='row'>
                  <div className='col-12 col-md-6'>
                    <BaseInput defaultValue={Number(0)} label="Select Answer" name="answer" type="select" options={answerOptions} />
                  </div>
                </div>
