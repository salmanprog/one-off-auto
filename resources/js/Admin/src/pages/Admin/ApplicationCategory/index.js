...
const ApplicationContent = () => {
  ...
  const column = [
    ...
    },
    {
      ...
      ...getColumnSearchProps('parent_category_name'),
    },
    {
      title: 'Slug',
      dataIndex: 'slug',
  ...
  const redirect_page = () => {
    return navigate("/admin/application-category/add");
  }
  return (
    ...
    <ContentWrapper title='Application Category'>
      <section className="main-content" style={{
        ...
        <div className="col-sm-12">
          ...
          <div className="col-sm-12">
            <Table columns={column} data={data} actions={['edit']} delete_opt='delete_application_category'/>
