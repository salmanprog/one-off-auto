...
const AddProductCategory = () => {
  ...
  const { loading, postData } = useFetch("create_product_category", "submit");
  ...
  const onFinish = (values) => {
    ...
    const callback = (receivedData) => {
      return navigate("/admin/product-category");
    };
          ...
          <div className="col-sm-12">
            ...
            >
              ...
              <UploadProfile
                ...
                static_img={imageUrl}
              />
              <BaseInput loading={loading} title={loading ? "Creating..." : "Create Category"} className="btn-theme2 btn-dark" type="submit" htmlType="submit" />
            </Form>
          </div>
        </div>
      </section>
...
export default React.memo(AddProductCategory);