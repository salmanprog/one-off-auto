...
const ApplicationFeedbackQuestion = () => {
  ...
  const redirect_page = () => {
    return navigate("/admin/feedback_question/add");
  }
  return (
    
    <ContentWrapper title='All Question'>
      <section className="main-content" style={{padding: '30px'}}>
        <div className='row'>
          ...
          <Button type="primary" onClick={redirect_page} style={{marginBottom:'10px',float:'right'}} htmlType="submit">Add New</Button>
            <Table columns={column} data={filteredData} actions={['edit','delete']} delete_opt='delete_feedback_question'/>
...
export default React.memo(ApplicationFeedbackQuestion);