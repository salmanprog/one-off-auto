...
const ApplicationBuildingType = () => {
  ...
  const redirect_page = () => {
    return navigate("/admin/building_types/add");
  }
  return (
    
    <ContentWrapper title='All BuildingTypes'>
      <section className="main-content" style={{padding: '30px'}}>
        <div className='row'>
          <div className="col-sm-12">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <h2>All BuildingTypes</h2>
                          <Input
          ...
          <Button type="primary" onClick={redirect_page} style={{marginBottom:'10px',float:'right'}} htmlType="submit">Add New</Button>
            <Table columns={column} data={filteredData} actions={['edit','delete']} delete_opt='delete_building_type'/>
...
export default React.memo(ApplicationBuildingType);